...
(function() {
  ...
  exports.blanket = (function() {
    var copynumber, coverageInfo, linesToAddBrackets, linesToAddTracking, options, _blanket;
    linesToAddTracking = ['ExpressionStatement', 'BreakStatement', 'ContinueStatement', 'VariableDeclaration', 'ReturnStatement', 'ThrowStatement', 'TryStatement', 'FunctionDeclaration', 'IfStatement', 'WhileStatement', 'DoWhileStatement', 'ForStatement', 'ForInStatement', 'SwitchStatement', 'WithStatement'];
    ...
    _blanket = {
      ...
      extend: function(obj) {
        return _blanket._extend(_blanket, obj);
      },
        ...
        if (source) {
          ...
          for (key in source) {
            ...
            if (dest[key] instanceof Object && typeof dest[key] !== 'function') {
              _results.push(_blanket._extend(dest[key], source[key]));
            } else {
      ...
      options: function(key, value) {
        if (typeof key !== 'string') {
          return _blanket._extend(options, key);
        ...
        return function(node) {
          ...
          if (linesToAddTracking.indexOf(node.type) > -1 && node.parent.type !== 'LabeledStatement') {
            ...
            if (node.loc && node.loc.start) {
              ...
              return _blanket._trackingArraySetup.push(node.loc.start.line);
            } else {
            ...
            return _blanket._trackBranch(node, filename);
          }
        };
      },
